...
//返回值:0,正常
//    其他,失败
/* fffeaf45,fffe585b,48d9
eae,ffffff51,ffffe045
131.000000
4000 */
...
/* 根据selftest写的自校准函数，避免上电每次都要等
fffeaf45,fffe585b,48d9
eae,ffffff51,ffffe045
131.000000
4000 */
void Offset6050(void)
{
	//int result;
	long gyro[3]={0xfffeaf45,0xfffe585b,0x48d9}, accel[3]={0xeae,0xffffff51,0xffffe045};

		float sens=131.000000;
		unsigned short accel_sens=0x4000;
		gyro[0] = (long)(gyro[0] * sens);
		gyro[1] = (long)(gyro[1] * sens);
		gyro[2] = (long)(gyro[2] * sens);
		dmp_set_gyro_bias(gyro);
