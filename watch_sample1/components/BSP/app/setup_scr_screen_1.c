...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->screen_1_img_1, &_back_alpha_240x280);
    ...
    lv_imgbtn_set_src(ui->screen_1_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, &_hai_alpha_60x60, NULL);
    lv_imgbtn_set_src(ui->screen_1_imgbtn_2, LV_IMGBTN_STATE_PRESSED, NULL, &_hai_alpha_60x60, NULL);
    ...
    lv_obj_set_pos(ui->screen_1_imgbtn_2, 88, 110);
    lv_obj_set_size(ui->screen_1_imgbtn_2, 60, 60);
    ...
    lv_imgbtn_set_src(ui->screen_1_imgbtn_3, LV_IMGBTN_STATE_RELEASED, NULL, &_zhi_alpha_60x60, NULL);
    lv_imgbtn_set_src(ui->screen_1_imgbtn_3, LV_IMGBTN_STATE_PRESSED, NULL, &_zhi_alpha_60x60, NULL);
    ...
    lv_obj_set_pos(ui->screen_1_imgbtn_3, 88, 202);
    lv_obj_set_size(ui->screen_1_imgbtn_3, 60, 60);
    ...
    lv_imgbtn_set_src(ui->screen_1_imgbtn_4, LV_IMGBTN_STATE_RELEASED, NULL, &_xin_alpha_60x60, NULL);
    lv_imgbtn_set_src(ui->screen_1_imgbtn_4, LV_IMGBTN_STATE_PRESSED, NULL, &_xin_alpha_60x60, NULL);
    ...
    lv_obj_set_pos(ui->screen_1_imgbtn_4, 88, 27);
    lv_obj_set_size(ui->screen_1_imgbtn_4, 60, 60);
